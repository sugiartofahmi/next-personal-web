    ...
    <Fragment>
      ...
      <div className="flex flex-col md:flex-row gap-x-5 gap-y-5">
        <div className="hover:scale-105 ease-in-out duration-300 transition flex flex-col justify-center w-full md:w-1/3 bg-blue-500 rounded-lg overflow-hidden text-white hover:bg-green-400 cursor-pointer">
          <img className="" src="/image/project-himatif.png" alt="HIMATIF" />
        ...
        <div className="hover:scale-105 ease-in-out duration-300 transition flex flex-col justify-center w-full md:w-1/3 bg-blue-500 rounded-lg overflow-hidden text-white hover:bg-green-400 cursor-pointer">
          <img className="" src="/image/project-survey.png" alt="Survey Form" />
          <div className="px-3 py-3">
      ...
      <div className="flex flex-col md:flex-row gap-x-5 gap-y-5">
        <div className="hover:scale-105 ease-in-out duration-300 transition flex flex-col justify-center w-full md:w-1/3 bg-blue-500 rounded-lg overflow-hidden text-white hover:bg-green-400 cursor-pointer">
          <img className="" src="/image/project-votsu.jpeg" alt="VOTING" />
          <div className="px-3 py-3">
        ...
        <div className="hover:scale-105 ease-in-out duration-300 transition flex flex-col justify-center w-full md:w-1/3 bg-blue-500 rounded-lg overflow-hidden text-white hover:bg-green-400 cursor-pointer">
          <img className="" src="/image/project-makrab.jpeg" alt="Makrab" />
          <div className="px-3 py-3">
        ...
        <div className="hover:scale-105 ease-in-out duration-300 transition flex flex-col justify-center w-full md:w-1/3 bg-blue-500 rounded-lg overflow-hidden text-white hover:bg-green-400 cursor-pointer">
          <img className="" src="/image/project-adhoc.png" alt="ADHOC" />
          <div className="px-3 py-3">
      ...
      <div className="flex flex-col md:flex-row gap-x-5 gap-y-5">
        <div className="hover:scale-105 ease-in-out duration-300 transition flex flex-col justify-center w-full md:w-1/3 bg-blue-500 rounded-lg overflow-hidden text-white hover:bg-green-400 cursor-pointer">
          <img className="" src="/image/project-taskxu.jpeg" alt="TASKXU" />
          <div className="px-3 py-3">
